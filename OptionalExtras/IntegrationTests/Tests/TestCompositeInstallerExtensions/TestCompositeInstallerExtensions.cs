...
namespace Zenject.Tests.Installers
{
    ...
    {
        private TestInstaller _installer1;
        private TestCompositeInstaller _compositeInstaller1;
        private TestCompositeInstaller _compositeInstaller2;
        private TestCompositeInstaller _circularRefCompositeInstaller1;
        private List<TestCompositeInstaller> _parentInstallers1;
        private TestInstaller _dummyInstaller1;
        private TestInstaller _dummyInstaller2;
        private TestInstaller _dummyInstaller3;
        private TestCompositeInstaller _dummyCompositeInstaller1;
        ...
        {
            TestCompositeInstaller circular = _circularRefCompositeInstaller1;
        ...
        {
            TestCompositeInstaller dummy = _dummyCompositeInstaller1;
            TestCompositeInstaller circular = _circularRefCompositeInstaller1;
