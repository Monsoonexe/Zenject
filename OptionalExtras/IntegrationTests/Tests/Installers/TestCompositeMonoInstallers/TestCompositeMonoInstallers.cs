...
namespace Zenject.Tests.Installers
{
    public class TestCompositeMonoInstallers : ZenjectIntegrationTestFixture
    {
        ...
        {
            CompositeMonoInstaller installerPrefab = Resources.Load<CompositeMonoInstaller>(resourcePath);
            CompositeMonoInstaller installer = GameObject.Instantiate(installerPrefab);
