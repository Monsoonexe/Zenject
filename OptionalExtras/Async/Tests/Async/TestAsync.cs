...
namespace Zenject.Tests.Bindings
{
    public class TestAsync : ZenjectIntegrationTestFixture
    {
        ...
        public IEnumerator TestSimpleMethod()
        {
            ...
            AsyncInject<IFoo> asycFoo = Container.Resolve<AsyncInject<IFoo>>();
        ...
        public IEnumerator TestUntypedInject()
        {
            ...
            IAsyncInject asycFoo = Container.Resolve<IAsyncInject>();
            yield return null;
        ...
        public IEnumerator TestPreloading()
        {
            ...
            foreach (IAsyncInject asycFooUntyped in testKernel.asyncInjects)
            {
