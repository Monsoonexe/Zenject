...
namespace Zenject
{
    public class ProjectContext : Context
    {
        ...
        [SerializeField]
        private ZenjectSettings _settings = ZenjectSettings.Default;
        ...
        {
            UnityEngine.Object[] prefabs = Resources.LoadAll(ProjectContextResourcePath, typeof(GameObject));
        ...
        private void Initialize()
        {
            ...
            TypeAnalyzer.ReflectionBakingCoverageMode = Application.isEditor ? _editorReflectionBakingCoverageMode : _buildsReflectionBakingCoverageMode;
        ...
        {
            _container.DefaultParent = _parentNewObjectsUnderContext ? transform : null;
