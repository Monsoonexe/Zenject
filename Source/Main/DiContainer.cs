...
namespace Zenject
{
    ...
    public class DiContainer : IInstantiator
    {
        ...
        {
            return binding.BindingInheritanceMethod == BindingInheritanceMethods.CopyIntoAll
...
|| ((binding.BindingInheritanceMethod == BindingInheritanceMethods.CopyDirectOnly
            ...
            Type concreteType, bool autoInject, List<TypeValuePair> extraArgs, InjectContext context, object concreteIdentifier)
        {
            ...
            if (concreteType.DerivesFrom<ScriptableObject>())
            {
                ...
                newObj = !IsValidating || allowDuringValidation ? ScriptableObject.CreateInstance(concreteType) : (object)new ValidationMarker(concreteType);
            }
            else
#endif
            {
            ...
            GameObjectCreationParameters gameObjectBindInfo, InjectContext context)
        {
            ...
            {
                return groupName == null ? null : (GameObject.Find("/" + groupName) ?? CreateTransformGroup(groupName)).transform;
            }
        ...
        public T InstantiateComponentOnNewGameObject<T>(string gameObjectName)
            where T : Component
        {
            return InstantiateComponentOnNewGameObject<T>(gameObjectName, Array.Empty<object>());
        }
